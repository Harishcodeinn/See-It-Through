    ...
    def send_email(self):
        ...
        def sendmail():
            ...
            while True:
                ...
                id1 = remove(id)
                rec = f"{id1}@gmail.com"
                self.speak(f"You have given the mail ID {rec}.")# Say 'yes' to confirm or 'no' to re-enter
    ...
    def run_reminder(self):
        ...
        try:
            ...
            if matches:
                ...
                self.label.text = f'Reminder set for {reminder_time.strftime("%I:%M %p")} and task is {message}'
